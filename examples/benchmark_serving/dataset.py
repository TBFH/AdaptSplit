...
def get_test_requests(
    ...
    args.num_req = num_req if num_req else float('inf')

    tokenizer = AutoTokenizer.from_pretrained(model_path, trust_remote_code=args.trust_remote_code)
    dataset = read_dataset(dataset_path, tokenizer, dataset_name, args)
    return dataset
...
if __name__ == "__main__":
    ...
    python dataset.py \
        ...
        --output-path /home/austin/datasets/test_request_datasets/sharegpt-opt-1.3b.bin \
        --num-req 5000
    '''
