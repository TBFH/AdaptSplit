...
from adaptsplit.request import Request, SamplingParams
...
class AsyncLLM:
    ...
    def from_engine_args(
        ...
        return AsyncLLM(
            ...
            prefill_sched_config=PrefillStageSchedConfig(
                policy=args.prefill_sched_policy,
                max_batch_size=args.prefill_max_batch_size,
                max_tokens_per_batch=args.prefill_max_tokens_per_batch
            ),
            decoding_sched_config=DecodingStageSchedConfig(
