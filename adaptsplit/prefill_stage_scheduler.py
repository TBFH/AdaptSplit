...
class PrefillStageScheduler(ABC):
    """
    PrefillStageScheduler: The abstract class for a prefill scheduler.
    ...
    def post_process(self) -> None:
        """
        Post process after each iteration. PrefillEventLoop will call this
        function after each iteration.
        """
        pass


class PrefillStageFCFSScheduler(PrefillStageScheduler):
    """
