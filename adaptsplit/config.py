...
from adaptsplit.utils import GB
...
class DisaggParallelConfig:
    ...
    Args:
        prefill: Prefill stage parallel config
    ...
    def get_num_workers(self) -> int:
        ...
        return self.prefill.world_size + self.decoding.world_size


class PrefillStageSchedConfig:
    """Configuration for the prefill stage scheduler.
